                ...
                <asp:Table ID="tblPageTitle" runat="server" Width="100%" BorderStyle="None" BorderWidth="0px" CellPadding="0" CellSpacing="0"> 
                    <asp:TableRow>
                        <asp:TableCell VerticalAlign="Bottom">
                            ...
                            &nbsp;<asp:Label id="lblAppTitle" runat="server" Height="100%" Text="Argix Direct Freight" />
                        </asp:TableCell>
                ...
                <table width="100%" border="1px" cellpadding="2px" cellspacing="2px">
                    <tr>
                        <td style="width:20%; text-align:center; border: solid 1px black">
                            <asp:ImageButton ID="imgFreight" runat="server" Height="24px" ImageUrl="~/App_Themes/Argix/Images/package.png" CommandName="Freight" />
                            <br /><asp:Label ID="lblFreight" runat="server" Text="Freight"></asp:Label>
                        </td>
                        <td style="width:20%; text-align:center; border: solid 1px black">
                            <asp:ImageButton ID="imgSorting" runat="server" Height="24px" ImageUrl="~/App_Themes/Argix/Images/barcode.png" CommandName="Sorting" />
                            <br /><asp:Label ID="lblSorting" runat="server" Text="Sorting"></asp:Label>
                        </td>
                        <td style="width:60%; text-align:center; border: solid 1px black">&nbsp;</td>
                    </tr>
                </table>
            </asp:TableCell>
        </asp:TableRow>
