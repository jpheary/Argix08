...
namespace Argix.Customers {
	...
	public class CustomerProxy {
        ...
        public Issue GetIssue(long issueID) {
            ...
            catch(TimeoutException te) { client.Abort(); throw new ApplicationException("GetIssue() timeout error.",te); }
            catch(CommunicationException ce) { client.Abort(); throw new ApplicationException("GetIssue() communication error.",ce); }
            return issue;
        }
