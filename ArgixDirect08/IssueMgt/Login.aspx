                ...
                <asp:Table ID="tblPageTitle" runat="server" Width="100%" BorderStyle="None" BorderWidth="0px" CellPadding="0" CellSpacing="0"> 
                    <asp:TableRow>
                        <asp:TableCell VerticalAlign="Bottom">
                            ...
                            &nbsp;<asp:Label id="lblAppTitle" runat="server" Height="100%" Text="Argix Direct Issue Management" />
                        </asp:TableCell>
                ...
                <table width="100%" border="1px" cellpadding="2px" cellspacing="2px">
                    <tr>
                        <td style="width:20%; text-align:center; border: solid 1px black">
                            <asp:ImageButton ID="imgIssues" runat="server" Height="24px" ImageUrl="~/App_Themes/Argix/Images/issues.png" />
                            <br /><asp:Label ID="lblIssues" runat="server" Text="Issues"></asp:Label>
                        </td>
                        <td style="width:20%; text-align:center; border: solid 1px black">
                            <asp:ImageButton ID="imgSearch" runat="server" Height="24px" ImageUrl="~/App_Themes/Argix/Images/search.png" />
