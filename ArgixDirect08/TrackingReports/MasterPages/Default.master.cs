...
public partial class DefaultMaster:System.Web.UI.MasterPage {
    ...
    public bool NavigatorVisible { 
        get { return this.tblNav.Visible; } 
        set {
    ...
    public Stream GetReportDefinition(string report) {
        ...
        SQLReports.ReportingService rs = new SQLReports.ReportingService();
        rs.Credentials = System.Net.CredentialCache.DefaultNetworkCredentials;
        byte[] bytes = rs.GetReportDefinition("/Argix08.Reports" + report);
    ...
    protected void Page_Load(object sender,EventArgs e) {
        ...
        if(!Page.IsPostBack) {
            ...
            this.tblFlyout.Visible = this.tblNav.Visible = !this.mHideNav;
            NavigatorVisible = !this.mHideNav;
            this.lnkTracking.Visible = this.lnkDDUTracking.Visible = !this.mHideNav;
        }
        else {
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        switch(e.CommandName) {
            case "ViewDept":
                this.trvMain.DataSourceID = "xmlDept";
                Session["View"] = "ViewDept";
                this.tcDept.Style["border-top-style"] = "none";
                this.btnViewDept.ForeColor = System.Drawing.SystemColors.Highlight;
                this.btnViewDept.Font.Bold = true;
                this.tcAlpha.Style["border-top-style"] = "solid";
                this.btnViewAlpha.ForeColor = System.Drawing.Color.Black;
                this.btnViewAlpha.Font.Bold = false;
                break;
            case "ViewAlpha":
                this.trvMain.DataSourceID = "xmlAlpha";
                Session["View"] = "ViewAlpha";
                this.tcDept.Style["border-top-style"] = "solid";
                this.btnViewDept.ForeColor = System.Drawing.Color.Black;
                this.btnViewDept.Font.Bold = false;
                this.tcAlpha.Style["border-top-style"] = "none";
                this.btnViewAlpha.ForeColor = System.Drawing.SystemColors.Highlight;
                this.btnViewAlpha.Font.Bold = true;
                break;
            case "Setup":
