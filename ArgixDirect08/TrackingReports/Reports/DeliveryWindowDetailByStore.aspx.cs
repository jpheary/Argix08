...
public partial class DeliveryWindowDetailByStore :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Delivery Window Detail By Store";
    private const string REPORT_SRC = "/Executive/Delivery Window Detail By Store";
    private const string REPORT_DS = "DeliveryWindowDetailByStoreDS";
    private const string USP_REPORT = "uspRptDeliveryWindowDetailByStore",TBL_REPORT = "NewTable";
    ...
    protected void Page_Load(object sender,EventArgs e) {
        ...
        if(!Page.IsPostBack) {
            ...
            if(this.cboException.Items.Count > 0) this.cboException.SelectedIndex = 0;
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _client,_division,_agent,_region,_district,_store,_start,_end,_exception });
