...
<asp:Label ID="Label1" runat="server" SkinID="lblTextDetail" Text="Tracking Results Summary" Width="775px" Height="28px" ></asp:Label>
                &nbsp;
                <br />
                <asp:GridView ID="grdTrack" runat="server" Width="775px" Height="96px" AutoGenerateColumns="False">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ItemNumber" DataTextField="ItemNumber" HeaderText="Tracking Number" DataNavigateUrlFormatString="Detail.aspx?ID={0}" NavigateUrl="~/Detail.aspx">
