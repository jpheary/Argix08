...
namespace Argix.Finance
{
    public partial class ThisWorkbook {
        //Members
        private const string USP_DETAIL = "uspInvTsortClientInvoiceSortedFreightGet",TBL_DETAIL = "ClientInvoiceWithStoreBLNumbersTable";

        private const int DETAIL_NUMBER_OF_COLUMNS = 20;
