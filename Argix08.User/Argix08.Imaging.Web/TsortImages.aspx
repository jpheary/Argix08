<%@ page language="C#" masterpagefile="~/Imaging.master" autoeventwireup="true" enableeventvalidation="false" CodeFile="TsortImages.aspx.cs" inherits="_TsortImages" title="Tsort Images Search 2.0.0" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <ContentTemplate>
        <table width="800px" border="0" cellpadding="0px" cellspacing="0px">
            ...
            <tr><td colspan="2"><h2>TSORT IMAGES</h2></td></tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cboDocClass" runat="server" DataSourceID="odsDocs" DataTextField="ClassName" DataValueField="ClassName" Width="144px" AutoPostBack="True" OnSelectedIndexChanged="OnDocClassChanged"></asp:DropDownList>
                    <asp:ObjectDataSource ID="odsDocs" runat="server" TypeName="Argix.Freight.ImagingService" SelectMethod="GetDocumentClasses" CacheExpirationPolicy="Sliding" CacheDuration="900" EnableCaching="true">
                        <SelectParameters>
                            <asp:Parameter Name="Department" DefaultValue="Tsort" Type="String" />
                        </SelectParameters>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="cboOperand3" runat="server" Width="72px" >
                        <asp:ListItem Value="AND">AND</asp:ListItem>
                        <asp:ListItem Value="OR">OR</asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:DropDownList ID="cboProp4" runat="server" DataSourceID="odsMetaData" DataTextField="Property" DataValueField="Property" Width="96px"></asp:DropDownList>
                    <asp:TextBox ID="txtSearch4" runat="server" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
