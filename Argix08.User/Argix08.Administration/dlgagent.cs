...
//	Author:	J. Heary
//	Date:	04/28/06
//	Desc:	Dialog to create a new agent or edit an existing agent.
//	Rev:	
//	---------------------------------------------------------------------------
using System;
...
namespace Tsort {
	//
	public class dlgAgentDetail : System.Windows.Forms.Form {
		//Members
		...
		private Tsort.Enterprise.AgentDS mAgentDS;
		...
		//Interface
		public dlgAgentDetail(ref AgentDS agent) {
			//Constructor
			try {
				InitializeComponent();
				...
				this.mAgentDS = agent;
				if(this.mAgentDS.AgentDetailTable.Count>0) {
					this.mAgentID = this.mAgentDS.AgentDetailTable[0].AgentID;
					this.Text = (this.mAgentID>0) ? "Agent (" + this.mAgentID + ")" : "Agent (New)";
				}
				else
					this.Text = "Agent (Data Unavailable)";
			} 
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(dlgAgentDetail));
			...
			this.mAgentDS = new Tsort.Enterprise.AgentDS();
			...
			this._lblName.Location = new System.Drawing.Point(177, 12);
			...
			this._lblCountry.Location = new System.Drawing.Point(255, 93);
			...
			this.cboCountries.Location = new System.Drawing.Point(321, 93);
			...
			this.cboCountries.SelectionChangeCommitted += new System.EventHandler(this.ValidateForm);
			// 
			// mCountriesDS
			// 
			...
			this.cboStates.SelectionChangeCommitted += new System.EventHandler(this.ValidateForm);
			// 
			// mStatesDS
			// 
			...
			this.chkStatus.Size = new System.Drawing.Size(84, 18);
			...
			// mAgentDS
			// 
			this.mAgentDS.DataSetName = "AgentDS";
			this.mAgentDS.Locale = new System.Globalization.CultureInfo("en-US");
			// 
			// tabDialog
			// 
			...
			this.grdPaymentServices.DataSource = this.mAgentDS;
			...
			this.grdPaymentServices.Location = new System.Drawing.Point(6, 12);
			this.grdPaymentServices.Name = "grdPaymentServices";
			this.grdPaymentServices.Size = new System.Drawing.Size(450, 249);
		...
		private void OnFormLoad(object sender, System.EventArgs e) {
			...
			try {
				...
				this.txtNumber.Text = this.mAgentDS.AgentDetailTable[0].Number;
				this.txtNumber.Enabled = (this.mAgentID==0);
				this.txtName.MaxLength = 30;
				this.txtName.Text = this.mAgentDS.AgentDetailTable[0].AgentName;
				
				this.txtLine1.MaxLength = 40;
				this.txtLine1.Text = this.mAgentDS.AgentDetailTable[0].AddressLine1;
				this.txtLine2.MaxLength = 40;
				this.txtLine2.Text = "";
				if(!this.mAgentDS.AgentDetailTable[0].IsAddressLine2Null())
					this.txtLine2.Text = this.mAgentDS.AgentDetailTable[0].AddressLine2;
				this.txtCity.MaxLength = 40;
				this.txtCity.Text = this.mAgentDS.AgentDetailTable[0].City;
				if(!this.mAgentDS.AgentDetailTable[0].IsStateOrProvinceNull()) 
					this.cboStates.SelectedValue = this.mAgentDS.AgentDetailTable[0].StateOrProvince;
				else
				...
				this.txtZip.Text = "";
				if(!this.mAgentDS.AgentDetailTable[0].IsPostalCodeNull())
					this.txtZip.Text = this.mAgentDS.AgentDetailTable[0].PostalCode;
				if(this.mAgentDS.AgentDetailTable[0].CountryID>0) 
					this.cboCountries.SelectedValue = this.mAgentDS.AgentDetailTable[0].CountryID;
				else
				...
				if(!this.mAgentDS.AgentDetailTable[0].IsContactNameNull())
					this.txtContact.Text = this.mAgentDS.AgentDetailTable[0].ContactName;
				this.mskPhone.InputMask = "###-###-####";
				if(!this.mAgentDS.AgentDetailTable[0].IsPhoneNull())
					this.mskPhone.Value = this.mAgentDS.AgentDetailTable[0].Phone;
				this.txtExt.MaxLength = 4;
				if(!this.mAgentDS.AgentDetailTable[0].IsExtensionNull())
					this.txtExt.Text = this.mAgentDS.AgentDetailTable[0].Extension;
				this.mskFax.InputMask = "###-###-####";
				if(!this.mAgentDS.AgentDetailTable[0].IsFaxNull())
					this.mskFax.Value = this.mAgentDS.AgentDetailTable[0].Fax;
				this.txteMail.MaxLength = 50;
				if(!this.mAgentDS.AgentDetailTable[0].IsEmailNull())
					this.txteMail.Text = this.mAgentDS.AgentDetailTable[0].Email;
				
				this.chkStatus.Checked = this.mAgentDS.AgentDetailTable[0].IsActive;
				...
				this.tabPaymentServices.Enabled = (this.mAgentID != 0);
			}
			...
			try {
				...
				switch(btn.Text) {
					...
					case CMD_OK:
						...
						this.Cursor = Cursors.WaitCursor;
						this.mAgentDS.AgentDetailTable[0].Number = this.txtNumber.Text;
						this.mAgentDS.AgentDetailTable[0].AgentName = this.txtName.Text;
						
						this.mAgentDS.AgentDetailTable[0].AddressLine1 = this.txtLine1.Text;
						if(this.txtLine2.Text!="")
							this.mAgentDS.AgentDetailTable[0].AddressLine2 = this.txtLine2.Text;
						else
							this.mAgentDS.AgentDetailTable[0].SetAddressLine2Null();
						this.mAgentDS.AgentDetailTable[0].City = this.txtCity.Text;
						this.mAgentDS.AgentDetailTable[0].StateOrProvince = this.cboStates.SelectedValue.ToString();
						this.mAgentDS.AgentDetailTable[0].PostalCode = this.txtZip.Text;
						this.mAgentDS.AgentDetailTable[0].CountryID = (int)this.cboCountries.SelectedValue;
						
						if(this.txtContact.Text!="")
							this.mAgentDS.AgentDetailTable[0].ContactName = this.txtContact.Text;
						else
							this.mAgentDS.AgentDetailTable[0].SetContactNameNull();
						this.mAgentDS.AgentDetailTable[0].Phone = this.mskPhone.Value.ToString();
						if(this.txtExt.Text!="")
							this.mAgentDS.AgentDetailTable[0].Extension = this.txtExt.Text;
						else
							this.mAgentDS.AgentDetailTable[0].SetExtensionNull();
						if(this.mskFax.Value!=System.DBNull.Value)
							this.mAgentDS.AgentDetailTable[0].Fax = this.mskFax.Value.ToString();
						else
							this.mAgentDS.AgentDetailTable[0].SetFaxNull();
						if(this.txteMail.Text!="")
							this.mAgentDS.AgentDetailTable[0].Email = this.txteMail.Text;
						else
							this.mAgentDS.AgentDetailTable[0].SetEmailNull();
						
						this.mAgentDS.AgentDetailTable[0].IsActive = this.chkStatus.Checked;
						//this.mAgentDS.AcceptChanges();
		...
		private void OnMenuClick(object sender, System.EventArgs e) {
			...
			dlgCompanyPaymentService dlgEntityPaymentService = null;
			CompanyDS dsCompanyPaymentService = null;
			CompanyDS.CompanyPaymentServiceTableRow rowEPS;
			AgentDS.CompanyPaymentServiceTableRow row;
			...
			try  {
				...
				switch(menu.Text)  {
					case MNU_PAYMENTSERVICE_ADD:
						...
						rowEPS.CompanyID = this.mAgentID;
						...
						dlgEntityPaymentService = new dlgCompanyPaymentService(this.mAgentID, this.chkStatus.Checked, ref dsCompanyPaymentService);
						res = dlgEntityPaymentService.ShowDialog(this);
						if(res==DialogResult.OK) {
							//Added new association
							//*** RESULT MUST MARK ROW AS DataRowState.Added
							row = this.mAgentDS.CompanyPaymentServiceTable.NewCompanyPaymentServiceTableRow();
							row.ItemArray = dsCompanyPaymentService.CompanyPaymentServiceTable[0].ItemArray;
							this.mAgentDS.CompanyPaymentServiceTable.AddCompanyPaymentServiceTableRow(row);
						}
						break;
