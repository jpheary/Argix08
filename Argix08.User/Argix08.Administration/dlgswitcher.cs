...
//	Author:	J. Heary
//	Date:	04/28/06
//	Desc:	Dialog to create a new switcher or edit an existing switcher.
//	Rev:	
//	---------------------------------------------------------------------------
using System;
...
namespace Tsort {
	//
	public class dlgSwitcherDetail : System.Windows.Forms.Form {
		//Members
		private int mSwitcherID=0;
		#region Controls
		...
		private Tsort.Transportation.SwitcherDS mSwitcherDS;
		...
		private void OnFormLoad(object sender, System.EventArgs e) {
			...
			try {
				...
				this.txtNameFirst.Text = "";
				this.txtNameFirst.Text = this.mSwitcherDS.SwitcherDetailTable[0].FirstName;
				this.txtNameLast.MaxLength = 40;
				this.txtNameLast.Text = "";
				this.txtNameLast.Text = this.mSwitcherDS.SwitcherDetailTable[0].LastName;
				this.mskPhone.InputMask = "###-###-####";
				if(!this.mSwitcherDS.SwitcherDetailTable[0].IsPhoneNull())
					this.mskPhone.Value = this.mSwitcherDS.SwitcherDetailTable[0].Phone;
				if(this.mSwitcherDS.SwitcherDetailTable[0].TerminalID!=0) 
					this.cboTerminal.SelectedValue = this.mSwitcherDS.SwitcherDetailTable[0].TerminalID;
				else
				...
				this.chkStatus.Checked = this.mSwitcherDS.SwitcherDetailTable[0].IsActive;
			}
			...
			try {
				...
				switch(btn.Text) {
					...
					case CMD_OK:
						...
						this.Cursor = Cursors.WaitCursor;
						this.mSwitcherDS.SwitcherDetailTable[0].FirstName = this.txtNameFirst.Text;
						this.mSwitcherDS.SwitcherDetailTable[0].LastName = this.txtNameLast.Text;
						if(this.mskPhone.Value!=System.DBNull.Value)
							this.mSwitcherDS.SwitcherDetailTable[0].Phone = this.mskPhone.Value.ToString();
						else
							this.mSwitcherDS.SwitcherDetailTable[0].SetPhoneNull();
						this.mSwitcherDS.SwitcherDetailTable[0].TerminalID = Convert.ToInt32(this.cboTerminal.SelectedValue);
						this.mSwitcherDS.SwitcherDetailTable[0].IsActive = this.chkStatus.Checked;
						this.mSwitcherDS.AcceptChanges();
