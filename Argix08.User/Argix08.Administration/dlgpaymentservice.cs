...
namespace Tsort {
	//
	public class dlgPaymentServiceDetail : System.Windows.Forms.Form {
		//Members
		...
		private Tsort.Enterprise.PaymentServiceDS mPaymentServicesDS;
		...
		private void OnFormLoad(object sender, System.EventArgs e) {
			...
			try {
				...
				this.txtNumber.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].PaymentServiceNumber;
				this.txtNumber.Enabled = (mPaymentServiceID==0);
				this.txtName.MaxLength = 30;
				this.txtName.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].PaymentServiceName;
				
				this.txtLine1.MaxLength = 40;
				this.txtLine1.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].AddressLine1;
				this.txtLine2.MaxLength = 40;
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsAddressLine2Null())
					this.txtLine2.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].AddressLine2;
				this.txtCity.MaxLength = 40;
				this.txtCity.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].City;
				if(this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsStateOrProvinceNull()) 
					this.cboStates.SelectedIndex = 0;
				else
					this.cboStates.SelectedValue = this.mPaymentServicesDS.PaymentServiceDetailTable[0].StateOrProvince;
				this.cboStates.Enabled = (this.cboStates.Items.Count>0);
				this.txtZip.MaxLength = 15;
				this.txtZip.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].PostalCode;
				if(this.mPaymentServicesDS.PaymentServiceDetailTable[0].CountryID==0) 
					this.cboCountries.SelectedIndex = 0;
				else
					this.cboCountries.SelectedValue = this.mPaymentServicesDS.PaymentServiceDetailTable[0].CountryID;
				this.cboCountries.Enabled = (this.cboCountries.Items.Count>0);
				
				this.txtContact.MaxLength = 30;
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsContactNameNull())
					this.txtContact.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].ContactName;
				this.mskPhone.InputMask = "###-###-####";
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsPhoneNull())
					this.mskPhone.Value = this.mPaymentServicesDS.PaymentServiceDetailTable[0].Phone;
				this.txtExt.MaxLength = 4;
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsExtensionNull())
					this.txtExt.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].Extension;
				this.mskFax.InputMask = "###-###-####";
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsFaxNull())
					this.mskFax.Value = this.mPaymentServicesDS.PaymentServiceDetailTable[0].Fax;
				this.txteMail.MaxLength = 50;
				if(!this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsEmailNull())
					this.txteMail.Text = this.mPaymentServicesDS.PaymentServiceDetailTable[0].Email;
				
				this.chkStatus.Checked = this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsActive;
			}
		...
		private void ValidateForm(object sender, System.EventArgs e) {
			//Event hanlder for all control changes
			try {
			...
			try {
				...
				switch(btn.Text) {
					...
					case CMD_OK:
						//General
						this.Cursor = Cursors.WaitCursor;
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].PaymentServiceNumber = this.txtNumber.Text;
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].PaymentServiceName = this.txtName.Text;
						
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].AddressLine1 = this.txtLine1.Text;
						if(this.txtLine2.Text!="")
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].AddressLine2 = this.txtLine2.Text;
						else
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].SetAddressLine2Null();
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].City = this.txtCity.Text;
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].StateOrProvince = this.cboStates.SelectedValue.ToString();
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].PostalCode = this.txtZip.Text;
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].CountryID = (int)this.cboCountries.SelectedValue;
						
						if(this.txtContact.Text!="")
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].ContactName = this.txtContact.Text;
						else
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].SetContactNameNull();
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].Phone = this.mskPhone.Value.ToString();
						if(this.txtExt.Text!="")
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].Extension = this.txtExt.Text;
						else
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].SetExtensionNull();
						if(this.mskFax.Value!=System.DBNull.Value)
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].Fax = this.mskFax.Value.ToString();
						else
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].SetFaxNull();
						if(this.txteMail.Text!="")
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].Email = this.txteMail.Text;
						else
							this.mPaymentServicesDS.PaymentServiceDetailTable[0].SetEmailNull();
						
						this.mPaymentServicesDS.PaymentServiceDetailTable[0].IsActive = this.chkStatus.Checked;
						
						this.mPaymentServicesDS.AcceptChanges();
