//	File:	dlgwarehouse.cs
//	Author:	J. Heary
//	Date:	04/28/06
//	Desc:	Dialog to create a new location or edit an existing location.
//	Rev:	
//	---------------------------------------------------------------------------
using System;
...
namespace Tsort {
	//
	public class dlgWarehouseDetail : System.Windows.Forms.Form {
		//Members
		...
		private Tsort.Enterprise.WarehouseDS mWarehouseDS;
		...
		//Interface
		public dlgWarehouseDetail(bool parentIsActive, ref WarehouseDS location) {
			//Constructor
			try {
				...
				this.mWarehouseDS = location;
				if(this.mWarehouseDS.WarehouseDetailTable.Count > 0) {
					this.mWarehouseID = this.mWarehouseDS.WarehouseDetailTable[0].LocationID;
					this.Text = (this.mWarehouseID>0) ? "Warehouse (" + this.mWarehouseID + ")" : "Warehouse (New)";
				}
				else
					this.Text = "Warehouse Location (Data Unavailable)";
			} 
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(dlgWarehouseDetail));
			...
			this.mWarehouseDS = new Tsort.Enterprise.WarehouseDS();
			...
			((System.ComponentModel.ISupportInitialize)(this.mWarehouseDS)).BeginInit();
			...
			this._lblName.Size = new System.Drawing.Size(90, 16);
			...
			this._lbleMail.Size = new System.Drawing.Size(72, 16);
			...
			this.fraAddress.Text = "Street Address";
			// 
			// _lblCountry
			// 
			...
			this._lblCountry.Location = new System.Drawing.Point(252, 96);
			this._lblCountry.Name = "_lblCountry";
			this._lblCountry.Size = new System.Drawing.Size(60, 16);
			...
			this._lblZip.Location = new System.Drawing.Point(144, 93);
			...
			this._lblExt.Size = new System.Drawing.Size(24, 16);
			...
			this._lblContact.Size = new System.Drawing.Size(72, 16);
			...
			// lblPhone
			// 
			this.lblPhone.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.chkStatus.Location = new System.Drawing.Point(252, 39);
			...
			this._lblNumber.Location = new System.Drawing.Point(6, 12);
			...
			this.txtNumber.Location = new System.Drawing.Point(84, 12);
			...
			this._lblFax.Size = new System.Drawing.Size(48, 16);
			...
			// mWarehouseDS
			// 
			this.mWarehouseDS.DataSetName = "WarehouseDS";
			this.mWarehouseDS.Locale = new System.Globalization.CultureInfo("en-US");
			// 
			// fraContact
			// 
			...
			this.txtMnemonic.Location = new System.Drawing.Point(84, 36);
			...
			this.fraHours.Size = new System.Drawing.Size(447, 60);
			this.fraHours.TabIndex = 35;
			this.fraHours.TabStop = false;
			this.fraHours.Text = "Location Hours";
			// 
			// tabfreight
			// 
			...
			// 
			this.chkIsLocationException.Location = new System.Drawing.Point(12, 114);
			this.chkIsLocationException.Name = "chkIsLocationException";
			this.chkIsLocationException.Size = new System.Drawing.Size(150, 20);
			this.chkIsLocationException.TabIndex = 28;
			...
			this.fraLocationException.TabIndex = 27;
			...
			this._lblDescription.Size = new System.Drawing.Size(78, 18);
			...
			// chkArgix
			// 
			this.chkArgix.Location = new System.Drawing.Point(91, 48);
			...
			this.txtLabelData.Size = new System.Drawing.Size(435, 21);
			this.txtLabelData.TabIndex = 20;
			...
			((System.ComponentModel.ISupportInitialize)(this.mWarehouseDS)).EndInit();
		...
		private void OnFormLoad(object sender, System.EventArgs e) {
			...
			try {			
				...
				this.txtNumber.Text = this.mWarehouseDS.WarehouseDetailTable[0].Number;
				this.txtNumber.Enabled = (mWarehouseID==0);
				this.txtName.MaxLength = 40;
				this.txtName.Text = this.mWarehouseDS.WarehouseDetailTable[0].Description;
				this.txtMnemonic.MaxLength = 3;
				this.txtMnemonic.Text = "";
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsMnemonicNull())
					this.txtMnemonic.Text = this.mWarehouseDS.WarehouseDetailTable[0].Mnemonic;
				
				this.txtLine1.MaxLength = 40;
				this.txtLine1.Text = this.mWarehouseDS.AddressDetailTable[0].AddressLine1;
				this.txtLine2.MaxLength = 40;
				if(!this.mWarehouseDS.AddressDetailTable[0].IsAddressLine2Null())
					this.txtLine2.Text = this.mWarehouseDS.AddressDetailTable[0].AddressLine2;
				this.txtCity.MaxLength = 40;
				this.txtCity.Text = this.mWarehouseDS.AddressDetailTable[0].City;
				//if(this.mWarehouseDS.WarehouseDetailTable[0].IsStateOrProvinceNull()) 
				//	this.cboStates.SelectedIndex = 0;
				//else
				this.cboStates.SelectedValue = this.mWarehouseDS.AddressDetailTable[0].StateOrProvince;
				this.cboStates.Enabled = (this.cboStates.Items.Count>0);
				this.txtZip.MaxLength = 15;
				//if(!this.mWarehouseDS.WarehouseDetailTable[0].IsPostalCodeNull())
					this.txtZip.Text = this.mWarehouseDS.AddressDetailTable[0].PostalCode;
				if(this.mWarehouseDS.AddressDetailTable[0].CountryID==0) 
					this.cboCountries.SelectedIndex = 0;
				else
					this.cboCountries.SelectedValue = this.mWarehouseDS.AddressDetailTable[0].CountryID;
				this.cboCountries.Enabled = (this.cboCountries.Items.Count>0);
				
				this.txtContact.MaxLength = 30;
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsContactNameNull())
					this.txtContact.Text = this.mWarehouseDS.WarehouseDetailTable[0].ContactName;
				this.mskPhone.InputMask = "###-###-####";
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsPhoneNull())
					this.mskPhone.Value = this.mWarehouseDS.WarehouseDetailTable[0].Phone;
				this.txtExt.MaxLength = 4;
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsExtensionNull())
					this.txtExt.Text = this.mWarehouseDS.WarehouseDetailTable[0].Extension;
				this.mskFax.InputMask = "###-###-####";
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsFaxNull())
					this.mskFax.Value = this.mWarehouseDS.WarehouseDetailTable[0].Fax;
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsEmailNull())
					this.txteMail.Text = this.mWarehouseDS.WarehouseDetailTable[0].Email;
				
				this.chkStatus.Checked = this.mWarehouseDS.WarehouseDetailTable[0].IsActive;
				if(!mParentIsActive) {
					//If parent is inactive: 1. Status MUST be inactive for new
					//					     2. Status cannot be changed for new or existing
					if(mWarehouseID==0) this.chkStatus.Checked = false;
					this.chkStatus.Enabled = false;
				}
				
				//Transporatation
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsOpenTimeNull())
					this.dtpOpen.Value = this.mWarehouseDS.WarehouseDetailTable[0].OpenTime;
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsCloseTimeNull())
					this.dtpClose.Value = this.mWarehouseDS.WarehouseDetailTable[0].CloseTime;

				//Freight
				this.txtSAN.MaxLength = 7;
				this.txtSAN.Text = "";
				this.txtSAN.Enabled = false;
//				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsSanNumberNull())
//					this.txtSAN.Text = this.mWarehouseDS.WarehouseDetailTable[0].SanNumber;
				this.txtLabelData.MaxLength = 25;
				this.txtLabelData.Text = "";
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsUserLabelDataNull())
					this.txtLabelData.Text = this.mWarehouseDS.WarehouseDetailTable[0].UserLabelData;
				if(!this.mWarehouseDS.WarehouseDetailTable[0].IsExceptionNull()) {
					this.chkIsLocationException.Checked = (true && this.mWarehouseDS.WarehouseDetailTable[0].Exception=="");
					this.chkIsLocationException.Checked = (true && this.mWarehouseDS.WarehouseDetailTable[0].Exception!="");
				}
				else
					OnLocationExceptionChecked(null, null);
				this.chkIsLocationException.Enabled = true;
			}
		...
		private void OnCountryChanged(object sender, System.EventArgs e) {
			...
			finally { ValidateForm(null, null); }
		}
		private void OnLocationExceptionChecked(object sender, System.EventArgs e) {
			//Event handler for change in choice of exception location
			try {
				if(this.chkIsLocationException.Checked == true) {
					...
					this.txtLocationException.Text = "";
					if(!this.mWarehouseDS.WarehouseDetailTable[0].IsExceptionNull())
						this.txtLocationException.Text = this.mWarehouseDS.WarehouseDetailTable[0].Exception;
					this.chkArgix.Checked = false;
					if(!this.mWarehouseDS.WarehouseDetailTable[0].IsIsArgixUseNull())
						this.chkArgix.Checked = this.mWarehouseDS.WarehouseDetailTable[0].IsArgixUse;
				}
				else {
					//Clear fields
			...
			try {
				...
				switch(btn.Text) {
					...
					case CMD_OK:
						//General
						this.Cursor = Cursors.WaitCursor;
						this.mWarehouseDS.WarehouseDetailTable[0].Number = this.txtNumber.Text;
						this.mWarehouseDS.WarehouseDetailTable[0].Description = this.txtName.Text;
						if(this.txtMnemonic.Text!="")
							this.mWarehouseDS.WarehouseDetailTable[0].Mnemonic = this.txtMnemonic.Text;
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetMnemonicNull();						
						this.mWarehouseDS.AddressDetailTable[0].AddressLine1 = this.txtLine1.Text;
						if(this.txtLine2.Text!="")
							this.mWarehouseDS.AddressDetailTable[0].AddressLine2 = this.txtLine2.Text;
						else
							this.mWarehouseDS.AddressDetailTable[0].SetAddressLine2Null();
						this.mWarehouseDS.AddressDetailTable[0].City = this.txtCity.Text;
						this.mWarehouseDS.AddressDetailTable[0].StateOrProvince = this.cboStates.SelectedValue.ToString();
						this.mWarehouseDS.AddressDetailTable[0].PostalCode = this.txtZip.Text;
						this.mWarehouseDS.AddressDetailTable[0].CountryID = (int)this.cboCountries.SelectedValue;
						
						if(this.txtContact.Text!="")
							this.mWarehouseDS.WarehouseDetailTable[0].ContactName = this.txtContact.Text;
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetContactNameNull();
						this.mWarehouseDS.WarehouseDetailTable[0].Phone = this.mskPhone.Value.ToString();
						if(this.txtExt.Text!="")
							this.mWarehouseDS.WarehouseDetailTable[0].Extension = this.txtExt.Text;
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetExtensionNull();
						if(this.mskFax.Value!=System.DBNull.Value)
							this.mWarehouseDS.WarehouseDetailTable[0].Fax = this.mskFax.Value.ToString();
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetFaxNull();
						if(this.txteMail.Text!="")
							this.mWarehouseDS.WarehouseDetailTable[0].Email = this.txteMail.Text;
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetEmailNull();
						this.mWarehouseDS.WarehouseDetailTable[0].IsActive = this.chkStatus.Checked;
						
						//Transportation
						if(this.fraHours.Enabled) {
							this.mWarehouseDS.WarehouseDetailTable[0].OpenTime = this.dtpOpen.Value;
							this.mWarehouseDS.WarehouseDetailTable[0].CloseTime = this.dtpClose.Value;
						}
						else {
							this.mWarehouseDS.WarehouseDetailTable[0].SetOpenTimeNull();
							this.mWarehouseDS.WarehouseDetailTable[0].SetCloseTimeNull();
						}
						
						//Freight
						//						if(this.txtSAN.Text!="")
						//							this.mWarehouseDS.WarehouseDetailTable.SanNumber = this.txtSAN.Text;
						//						else
						//							this.mWarehouseDS.WarehouseDetailTable.SetSanNumberNull();
						if(this.txtLabelData.Text!="")
							this.mWarehouseDS.WarehouseDetailTable[0].UserLabelData = this.txtLabelData.Text;					
						else
							this.mWarehouseDS.WarehouseDetailTable[0].SetUserLabelDataNull();
						if(this.chkIsLocationException.Checked) {
							this.mWarehouseDS.WarehouseDetailTable[0].Exception = this.txtLocationException.Text;
							this.mWarehouseDS.WarehouseDetailTable[0].IsArgixUse = this.chkArgix.Checked;
						}
						else {
							this.mWarehouseDS.WarehouseDetailTable[0].SetExceptionNull();
							this.mWarehouseDS.WarehouseDetailTable[0].SetIsArgixUseNull();
						}
						
						this.mWarehouseDS.AcceptChanges();
