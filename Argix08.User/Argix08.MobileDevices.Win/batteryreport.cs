...
namespace Argix.Terminals {
	//
	public class frmBatteryReport : System.Windows.Forms.Form {
        //Members
		#region Controls
		...
		public frmBatteryReport() {
			...
			catch(Exception ex) { throw new ApplicationException("Failed to create new Battery Report window", ex); }
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmBatteryReport));
            ...
            this.rsViewer.ServerReport.DisplayName = "Battery Detail";
            this.rsViewer.ServerReport.ReportPath = "/Terminals/Mobile Devices Battery Detail";
            ...
            this.Name = "frmBatteryReport";
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Battery Report";
