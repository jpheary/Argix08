...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members
        private const string USP_DETAIL = "uspInvTsortClientInvoiceSortedFreightGet",TBL_DETAIL = "ClientInvoiceTable";
        ...
        private void createDetailBody(InvoiceDS.ClientInvoiceTableDataTable invoiceTable) {
            ...
            Excel.Range row0 = ws.get_Range(ws.Cells[ROW0_DETAIL + 1,1],ws.Cells[ROW0_DETAIL + 1,21]).EntireRow;
            ...
            for(int i=0;i<rowCount;i++) {
                ...
                values[i,20] = invoiceTable[i].MasterBLNumber;
            }
            ws.get_Range(ws.Cells[ROW0_DETAIL,1],ws.Cells[ROW0_DETAIL + rowCount - 1,21]).Value2 = values;
