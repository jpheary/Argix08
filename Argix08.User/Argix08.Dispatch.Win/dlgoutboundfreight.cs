//	File:	dlgoutboundfreight.cs
//	Author:	J. Heary
//	Date:	09/29/05
//	Desc:	Dialog to view/edit freight on the outbound schedule.
//	Rev:	
//	---------------------------------------------------------------------------
using System;
...
namespace Argix.Dispatch {
	//
	public class dlgOutboundFreight : Argix.Dispatch.dlgSchedule {
		//Members
		//Constants
		//Events
		#region Controls
		...
		private void InitializeComponent() {
			...
			this._lblCreatedBy.Text = "CreatedBy: ";
			...
			this._lblTitle.Location = new System.Drawing.Point(213, 6);
			this._lblTitle.Name = "_lblTitle";
			this._lblTitle.Size = new System.Drawing.Size(240, 32);
			this._lblTitle.TabIndex = 127;
			this._lblTitle.Text = "Outbound Freight";
			...
			// _lblComments
			// 
			this._lblComments.Location = new System.Drawing.Point(27, 195);
			...
			// chkConfirmed
			// 
			this.chkConfirmed.Location = new System.Drawing.Point(132, 279);
