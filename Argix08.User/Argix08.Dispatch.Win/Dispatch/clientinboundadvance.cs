...
namespace Argix.Dispatch {
	//
	public class ClientInboundAdvance: DispatchSchedule {
		//Members
		//Constants		
		//Events
		//Interface
		public ClientInboundAdvance(Mediator mediator): base("Advance Inbound Sheet","ClientInboundTable","_clientinboundadvance",mediator) { }
		...
		public override int Count { get { return base.mSchedule.ClientInboundTable.Rows.Count; } }
