...
namespace Argix.Dispatch {
	//
	public class TrailerLogArchive: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public TrailerLogArchive(Mediator mediator): base("Trailer Tracking Archive","TrailerLogTable","_trailerentryarchive",mediator) { }
