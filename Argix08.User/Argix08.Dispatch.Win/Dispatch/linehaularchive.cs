...
namespace Argix.Dispatch {
	//
	public class LineHaulArchive: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public LineHaulArchive(Mediator mediator): base("Archive of Line Haul Schedule","LineHaulTable","_linehaularchive",mediator) { }
