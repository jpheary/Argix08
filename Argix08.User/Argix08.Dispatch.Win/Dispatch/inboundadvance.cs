...
namespace Argix.Dispatch {
	//
	public class InboundAdvance: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public InboundAdvance(Mediator mediator): base("Advance Inbound","ScheduledInboundTable","_inboundadvance",mediator) { }
