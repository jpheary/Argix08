...
namespace Argix.Dispatch {
	//
	public class ClientInboundSchedule: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public ClientInboundSchedule(string scheduleName, string tableName, string dataFile, Mediator mediator): base(scheduleName,tableName,dataFile,mediator) { }
