...
namespace Argix.Dispatch {
	//
	public class PickupLog: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public PickupLog(string scheduleName, string tableName, string dataFile, Mediator mediator): base(scheduleName,tableName,dataFile,mediator) { }
