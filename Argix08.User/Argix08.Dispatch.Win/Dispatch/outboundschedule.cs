...
namespace Argix.Dispatch {
	//
	public class OutboundSchedule: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public OutboundSchedule(string scheduleName, string tableName, string dataFile, Mediator mediator): base(scheduleName,tableName,dataFile,mediator) { }
