...
namespace Argix.Dispatch {
	//
	public class LineHaulAdvance: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public LineHaulAdvance(Mediator mediator): base("Advance Line Haul Schedule","LineHaulTable","_linehauladvance",mediator) { }
