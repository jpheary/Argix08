...
namespace Argix.Dispatch {
	//
	public class InboundArchive: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public InboundArchive(Mediator mediator): base("Archive of Inbound Freight","ScheduledInboundTable","_inboundarchive",mediator) { }
