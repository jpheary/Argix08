...
namespace Argix.Dispatch {
	//
	public class OutboundArchive: DispatchSchedule {
		//Members
		//Constants
		//Events
		//Interface
		public OutboundArchive(Mediator mediator): base("Archive of Outbound Freight","ScheduledOutboundTable","_outboundarchive",mediator) { }
