<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="USPS.aspx.cs" Inherits="_USPS" %>
...
<body style="font-size: 8pt; color: buttontext; font-family: Verdana; background-color: buttonface;">
    <form id="form1" runat="server">
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="buttonface">
            <tr><td style="font-weight: bold; font-size: 12pt; text-transform: uppercase; font-style: italic">
                USPS Web Service Client</td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td valign="top">
                    <table border="0" cellpadding="0" cellspacing="3" height="100%" width="100%">
                        <tr>
                            ...
                            <td colspan="4"><asp:TextBox ID="txtService" runat="server" Width="100%" ReadOnly="True"></asp:TextBox></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td width="144"><asp:TextBox ID="txtPassword" runat="server" Width="96px"></asp:TextBox>
