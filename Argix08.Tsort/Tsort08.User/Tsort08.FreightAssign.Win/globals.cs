...
namespace Argix {
    ...
    public class App:AppBase {
        ...
        public const string USP_TRACE = "uspFALogEntryNew";
    ...
    internal class Config:AppConfig {
        //Members
        public const string KEY_FREIGHTSYNCDAYSMAX = "FreightSyncDaysMax";
        public const string KEY_SORTEDDAYSMAX = "SortedDaysMax";
        public const string KEY_SORTEDDAYSPW = "SortedDaysPwd";

        //Interface
        public Config(string PCName,DataSet ds,Mediator mediator) : base(PCName,ds,mediator) { }

        [Category("Behavior"),Description("Maximum value for freight sync days setting.")]
        public int FreightSyncDaysMax {
            get { return GetValueAsInteger(KEY_FREIGHTSYNCDAYSMAX); }
        }
        [Category("Behavior"),Description("Maximum value for sorted days setting.")]
        public int SortedDaysMax {
            get { return GetValueAsInteger(KEY_SORTEDDAYSMAX); }
        }
        [Category("Accessibility"),Description("Password to change sorted days value.")]
        public string SortedDaysPassword {
            get { return GetValue(KEY_SORTEDDAYSPW); }
        }
    }
    ...
    namespace Freight {
        public enum ShipmentStatusEnum { Unknown=0, Unsorted=1, Sorting=2, Sorted=3 }
    }
}