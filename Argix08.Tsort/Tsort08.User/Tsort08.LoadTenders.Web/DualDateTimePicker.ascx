...
<asp:Table runat="server" ID="tblControl" Width="100%" BorderStyle="None" BorderWidth="2px" CellPadding="2" CellSpacing="2">
    <asp:TableRow runat="server" ID="rowFrom">
        ...
        <asp:TableCell Width="32px">
            &nbsp;<asp:ImageButton ID="imgFrom" runat="server" ImageUrl="~/App_Themes/Argix/Images/calendar.gif" ImageAlign="AbsMiddle" ToolTip="Open the from calendar popup" OnClick="OnShowFromDateCalendar" />
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow runat="server" ID="rowTo">
        ...
        <asp:TableCell Width="32px">
            &nbsp;<asp:ImageButton ID="imgTo" runat="server" ImageUrl="~/App_Themes/Argix/Images/calendar.gif" ImageAlign="AbsMiddle" ToolTip="Open the to calendar popup" OnClick="OnShowToDateCalendar" />
        </asp:TableCell>
    </asp:TableRow>
</asp:Table>
