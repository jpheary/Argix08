...
namespace Argix {
    ...
    internal class Config:AppConfig {
        //Members
        public const string KEY_CLOSEDTLSDAYS = "ClosedTLsDays";
        public const string KEY_SHOWLANECHANGES = "ShowLaneChanges";
        public const string KEY_SHOWSHIPSCHEDULE = "ShowShipSchedule";

        //Interface
        public Config(string PCName,DataSet ds,Mediator mediator) : base(PCName,ds,mediator) { }

        [Category("Behavior"),Description("")]
        public int ClosedTLsDays {
            get { return GetValueAsInteger(KEY_CLOSEDTLSDAYS); }
            set { SetValue(KEY_CLOSEDTLSDAYS,value.ToString()); }
        }
        [Category("Accessibility"),Description("")]
        public bool ShowLaneChanges {
            get { return GetValueAsBoolean(KEY_SHOWLANECHANGES); }
            set { SetValue(KEY_SHOWLANECHANGES,value.ToString()); }
        }
        [Category("Accessibility"),Description("")]
        public bool ShowShipSchedule {
            get { return GetValueAsBoolean(KEY_SHOWSHIPSCHEDULE); }
            set { SetValue(KEY_SHOWSHIPSCHEDULE,value.ToString()); }
        }
    }
