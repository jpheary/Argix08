...
namespace Argix {
	...
	public class App: AppBase {
        ...
        public const string USP_TRACE = "uspIndFALogEntryNew";		
    ...
    internal class Config : AppConfig {
        //Members
        public const string KEY_ALLOWNEW = "ManualEntry";
        public const string KEY_ALLOWIMPORT = "ManualImport";
        public const string KEY_EXPORTPATH = "ExportPath";
        public const string KEY_IMPORTFILE = "ImportFile";
        public const string KEY_TRIPDAYS = "TripDays";
        ...
        public bool ManualEntry {
            get { return GetValueAsBoolean(KEY_ALLOWNEW); }
        }
        [Category("Behavior"), Description(".")]
        public bool ManualImport {
            get { return GetValueAsBoolean(KEY_ALLOWIMPORT); }
        }
        [Category("Behavior"), Description(".")]
        public string ExportPath {
            get { return GetValue(KEY_EXPORTPATH); }
        }
        [Category("Behavior"), Description(".")]
        public string ImportFile {
            get { return GetValue(KEY_IMPORTFILE); }
        }
        [Category("Behavior"), Description(".")]
        public int TripDays {
            get { return GetValueAsInteger(KEY_TRIPDAYS); }
        }
    }
}