//	File:	constantscale.cs
//	Author:	J. Heary
//	Date:	01/24/05
//	Desc:	Implementation of IScale where weight is a constant.
//	---------------------------------------------------------------------------
using System;
using System.Threading;

namespace Tsort.Devices.Scales {
    /// <summary>Implementation of IScale where weight is a constant.</summary>
	public class ConstantScale : IScale {
		//Members
