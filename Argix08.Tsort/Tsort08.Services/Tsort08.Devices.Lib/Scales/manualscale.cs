...
//	Author:	J. Heary
//	Date:	01/24/05
//	Desc:	Implementation of IScale where weight is either constant or manually 
//          entered by the user.
//  Rev:    
//	---------------------------------------------------------------------------
using System;
...
namespace Tsort.Devices.Scales {
    /// <summary>Implementation of IScale where weight is either constant or manually entered by the user.</summary>
	public class ManualScale : IScale {
		//Members
