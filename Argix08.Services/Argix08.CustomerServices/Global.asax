...
<script runat="server">
    void Application_Start(object sender, EventArgs e) {
        ...
        //Trace("Argix08.FreightService web application startup",LogSvc.LogLevel.Information);
    }
    void Application_End(object sender, EventArgs e) {
        //Code that runs on application shutdown
        //Trace("Argix08.FreightService web application shutdown",LogSvc.LogLevel.Information);
    }
    void Application_Error(object sender,EventArgs e) {
        ...
        if(exc != null && exc.GetType() == typeof(System.Web.HttpException)) {
            ...
            Response.Write("<h2>Customer Service Error</h2>\n");
            if(exc != null)
