...
public partial class OnTimeCartonByDeliverySummary:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time Carton By Delivery Summary";
    private const string REPORT_SRC = "/Executive/On Time Carton By Delivery Summary";
    private const string REPORT_DS = "OnTimeCartonByDeliverySummaryDS";
    private const string USP_REPORT = "uspRptOnTimeCartonByDeliverySummary",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _from,_to,_client,_agent,_pctontome });
