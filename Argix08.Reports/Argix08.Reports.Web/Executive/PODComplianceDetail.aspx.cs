...
public partial class PODComplianceDetail :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "POD Compliance Detail";
    private const string REPORT_SRC = "/Executive/POD Compliance Detail";
    private const string REPORT_DS = "PODComplianceDetailDS";
    private const string USP_REPORT = "uspRptPODComplianceDetail",TBL_REPORT = "NewTable";
