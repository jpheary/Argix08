...
public partial class OnTimeDeliveryDetailByStore :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time Delivery Detail By Store";
    private const string REPORT_SRC = "/Executive/On Time Delivery Detail By Store";
    private const string REPORT_DS = "OnTimeDeliveryDetailByStoreDS";
    private const string USP_REPORT = "uspRptOnTimeDeliveryDetailByStore",TBL_REPORT = "NewTable";
        ...
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=OnTimeDeliveryDetailByStore.xls");
