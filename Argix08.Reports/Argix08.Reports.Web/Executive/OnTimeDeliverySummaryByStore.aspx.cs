...
public partial class OnTimeDeliverySummaryByStore :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time Delivery Summary By Store";
    private const string REPORT_SRC = "/Executive/On Time Delivery Summary By Store";
    private const string REPORT_DS = "OnTimeDeliverySummaryByStoreDS";
    private const string USP_REPORT = "uspRptOnTimeDeliverySummaryByStore",TBL_REPORT = "NewTable";
        ...
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=OnTimeDeliverySummaryByStore.xls");
