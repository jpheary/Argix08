...
public partial class DeliveryWindowSummaryByAgent :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Delivery Window Summary By Agent";
    private const string REPORT_SRC = "/Executive/Delivery Window Summary By Agent";
    private const string REPORT_DS = "DeliveryWindowSummaryByAgentWithEarlyDS";
    private const string USP_REPORT = "uspRptDeliveryWindowSummaryByAgentWithEarly",TBL_REPORT = "NewTable";
        ...
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                case "Run":
                    ...
                    DataSet _ds = enterprise.FillDataset("uspRptClientRead", TBL_REPORT, new object[] { _client });
