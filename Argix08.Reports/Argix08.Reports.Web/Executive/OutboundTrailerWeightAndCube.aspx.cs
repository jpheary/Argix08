...
public partial class OutboundTrailerWeightAndCube:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Outbound Trailer Weight and Cube";
    private const string REPORT_SRC = "/Executive/Outbound Trailer Weight And Cube";
    private const string REPORT_DS = "OBTrailerWeightCubeDS";
    private const string USP_REPORT = "uspRptBOLWeightCubeReport",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(this.cboType.SelectedValue,TBL_REPORT,new object[] { _start,_end,_agent,_terminal });
