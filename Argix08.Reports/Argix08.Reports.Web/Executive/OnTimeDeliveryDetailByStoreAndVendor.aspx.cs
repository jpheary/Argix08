...
public partial class OnTimeDeliveryDetailByStoreAndVendor :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time Delivery Detail By Store And Vendor";
    private const string REPORT_SRC = "/Executive/On Time Delivery Detail By Store And Vendor";
    private const string REPORT_DS = "OnTimeDeliveryDetailByStoreAndVendorDS";
    private const string USP_REPORT = "uspRptOnTimeDeliveryDetailByStoreAndVendor",TBL_REPORT = "NewTable";
    ...
    protected void Page_Load(object sender,EventArgs e) {
        ...
        Master.ClientChanged += new EventHandler(OnClientChanged);
    }
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _client,_division,_agent,_region,_district,_store,_start,_end,_isException,_vendor,_vendorLoc });
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                case "Run":
                    ...
                    ReportParameter vendor = new ReportParameter("VendorCompany"); if(_vendor != null) vendor.Values.Add(_vendor);
                    ReportParameter vendorLoc = new ReportParameter("VendorLocation"); if(_vendorLoc != null) vendorLoc.Values.Add(_vendorLoc);
