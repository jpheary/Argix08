...
public partial class ScanningSummaryByClient :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Scanning Summary By Client";
    private const string REPORT_SRC = "/Executive/Scanning Summary By Client";
    private const string REPORT_DS = "ScanningSummaryByClientDS";
    private const string USP_REPORT = "uspRptScanningSummaryByClient",TBL_REPORT = "NewTable";
