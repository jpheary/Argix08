<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="OnTimeCartonByDeliveryDate.aspx.cs" Inherits="OnTimeCartonByDeliveryDate" %>
...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0px" cellspacing="3px">
        ...
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
        <tr><td colspan="3">&nbsp;<uc4:ClientAgentGrids ID="dgdClientAgent" runat="server" Height="288px" ClientDivision="01" ClientActiveOnly="true" ClientsEnabled="true" AgentsEnabled="true" OnAfterClientSelected="OnClientSelected" OnAfterAgentSelected="OnAgentSelected" /></td></tr>
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
   </table>
</asp:Panel>
</asp:Content>
