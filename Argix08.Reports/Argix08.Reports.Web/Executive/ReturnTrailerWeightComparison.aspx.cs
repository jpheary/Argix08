...
public partial class ReturnTrailerWeightComparison:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Return Trailer Weight Comparison";
    private const string REPORT_SRC = "/Executive/Return Trailer Weight Comparison";
    private const string REPORT_DS = "ReturnTrailerWeightComparisonDS";
    private const string USP_REPORT = "uspRptReturnTrailerWeightComparison",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _start,_end,_agent });
