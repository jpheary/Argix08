...
public partial class VirtualvsOptimizedTrailerLoad :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Virtual vs Optimized Trailer Load";
    private const string REPORT_SRC = "/Executive/Virtual vs Optimized Trailer Load";
    private const string REPORT_DS = "VirtualOptimizedDS";
    private const string USP_REPORT = "uspRptVirtualVersusOptimizedTrailerLoad",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _from,_to,_zone,_weight,_cube });
