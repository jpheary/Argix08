...
public partial class ScanningSummaryByAgent :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Scanning Summary By Agent";
    private const string REPORT_SRC = "/Executive/Scanning Summary By Agent";
    private const string REPORT_DS = "ScanningSummaryByAgentDS";
    private const string USP_REPORT = "uspRptScanningSummaryByAgent",TBL_REPORT = "NewTable";
