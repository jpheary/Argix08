...
public partial class StatSample :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Statistical Sampling";
    private const string REPORT_SRC = "/Operations/Statistical Sampling";
    private const string REPORT_DS = "StatSampleDS";
    private const string USP_REPORT = "uspRptStatSample", TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _from,_to });
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                case "Run":
                    ...
                    report.SetParameters(new ReportParameter[] { from,to });
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=StatisticalSampling.xls");
