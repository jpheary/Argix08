...
public partial class StationTotals :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Station Totals";
    private const string REPORT_SRC = "/Operations/Station Totals";
    private const string REPORT_DS = "StationTotalsDS";
    private const string USP_REPORT = "uspRptStationPerformance",TBL_REPORT = "NewTable";
