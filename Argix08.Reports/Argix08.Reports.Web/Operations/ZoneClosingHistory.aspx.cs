...
public partial class ZoneClosingHistory :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Zone Closing History";
    private const string REPORT_SRC = "/Operations/Zone Closing History";
    private const string REPORT_DS = "ZoneClosingHistoryDS";
    private const string USP_REPORT = "uspRptZoneClosingHistoryGetList",TBL_REPORT = "NewTable";
        ...
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=ZoneClosingHistory.xls");
