...
public partial class MultipleCartonSearch :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Multiple Carton Search";
    private const string REPORT_SRC = "/Operations/Multiple Carton Search";
    private const string REPORT_DS = "MultipleCartonSearchDS";
    private const string USP_REPORT = "uspRptSortedItemGetListForLabelSequenceNumberFromText",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _text,_terminal });
