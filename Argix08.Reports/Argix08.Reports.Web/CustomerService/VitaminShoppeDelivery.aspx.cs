...
public partial class VitaminShoppeDelivery:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Vitamin Shoppe Delivery";
    private const string REPORT_SRC = "/Customer Service/Vitamin Shoppe Delivery";
    private const string REPORT_DS = "VitaminShoppeDeliveryDS";
    private const string USP_REPORT = "uspRptVShopShipmentsByDeliveryDate",TBL_REPORT = "NewTable";
