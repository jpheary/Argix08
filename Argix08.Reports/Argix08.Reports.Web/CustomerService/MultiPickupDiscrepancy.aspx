<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="MultiPickupDiscrepancy.aspx.cs" Inherits="MultiPickupDiscrepancy" %>
                        ...
                        <td valign="top">
                            ...
                            <ContentTemplate>
                                <asp:Panel id="pnlPickups" runat="server" Width="100%" Height="144px" BorderStyle="Inset" BorderWidth="1px" ScrollBars="Auto">
                                    <asp:GridView ID="grdPickups" runat="server" Width="100%" DataSourceID="odsPickups" AutoGenerateColumns="False" DataKeyNames="PickupID,VendorNumber,PUDate,PUNumber" AllowSorting="True">
                                        <Columns>
