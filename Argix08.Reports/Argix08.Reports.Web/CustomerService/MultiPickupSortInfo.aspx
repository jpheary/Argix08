<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="MultiPickupSortInfo.aspx.cs" Inherits="MultiPickupSortInfo" %>
...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0" cellspacing="3px">
        ...
        <tr>
            <td colspan="2">&nbsp;<uc1:DualDateTimePicker ID="ddpPickups" runat="server" Width="384px" LabelWidth="96px" DateDaysBack="90" DateDaysForward="0" DateDaysSpread="7" OnDateTimeChanged="OnFromToDateChanged" /></td>
            <td>&nbsp;</td>
        </tr>
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
        <tr><td colspan="3" align="right"><asp:CheckBox ID="chkAllVendors" runat="server" Text="Pickups for all vendors" TextAlign="Left" Checked="true" OnCheckedChanged="OnAllVendorsChecked" AutoPostBack="True" /></td></tr>
         <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
                        ...
                        <td valign="top">
                            ...
                            <ContentTemplate>
                                <asp:Panel id="pnlPickups" runat="server" Width="100%" Height="144px" BorderStyle="Inset" BorderWidth="1px" ScrollBars="Auto">
                                    <asp:GridView ID="grdPickups" runat="server" Width="100%" DataSourceID="odsPickups" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="PickupID,VendorNumber,PUDate,PUNumber">
                                        <Columns>
