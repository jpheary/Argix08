...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0" cellspacing="3px">
        ...
        <tr>
            <td colspan="2"><uc1:DualDateTimePicker ID="ddpPickups" runat="server" Width="336px" LabelWidth="96px" DateDaysBack="365" DateDaysForward="0" DateDaysSpread="14" OnDateTimeChanged="OnFromToDateChanged" />
            <td>&nbsp;</td>
        </tr>
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
        <tr>
            <td align="right">Damage Code&nbsp;</td>
            <td>
                <asp:DropDownList ID="cboDamageCode" runat="server" Width="192px" DataSourceID="odsDamageCodes" DataTextField="DESCRIPTION" DataValueField="CODE"></asp:DropDownList>
        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0px" cellpadding="0px" cellspacing="0px">
                    ...
                    <tr>
                        <td valign="top">
                            <asp:Panel id="pnlPickups" runat="server" Width="100%" Height="138px" BorderStyle="Inset" BorderWidth="1px" ScrollBars="Auto">
