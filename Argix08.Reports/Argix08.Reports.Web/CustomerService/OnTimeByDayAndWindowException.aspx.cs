...
public partial class OnTimeByDayAndWindowException :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time By Day And Window Exception";
    private const string REPORT_SRC = "/Customer Service/On Time By Day And Window Exception";
    private const string REPORT_DS = "OnTimeExceptionDS";
    private const string USP_REPORT = "uspRptOnTimeReportByDayAndWindowException",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _client,_div,_from.ToString("yyyy-MM-dd"),_to.ToString("yyyy-MM-dd"),(_agent == "All" ? null : _agent) });
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                case "Run":
                    ...
                    report.SetParameters(new ReportParameter[] { client,div,from,to,agent,clientName });
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=OnTimeByDayAndWindowException.xls");
