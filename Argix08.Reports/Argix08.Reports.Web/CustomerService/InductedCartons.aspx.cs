...
public partial class InductedCartons :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Inducted Cartons";
    private const string REPORT_SRC = "/Customer Service/Inducted Cartons";
    private const string REPORT_DS = "DataSet";
    private const string USP_REPORT = "uspRptInductedCartonsGetList",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _blNumber,_terminalCode });
