...
public partial class MultiPickupDiscrepancy :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Multiple Pickup Combined Discrepancy";
    private const string REPORT_SRC = "/Customer Service/Multiple Pickup Combined Discrepancy";
    private const string REPORT_DS = "MultiPUCombinedDiscrepancyDS";
    private const string USP_REPORT = "uspRptDiscrepancyMultiPickup",TBL_REPORT = "NewTable";
