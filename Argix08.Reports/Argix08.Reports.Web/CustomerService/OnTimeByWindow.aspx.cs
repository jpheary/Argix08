...
public partial class OnTimeByWindow :System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "On Time By Window";
    private const string REPORT_SRC = "/Customer Service/On Time By Window";
    private const string REPORT_DS = "OnTimeReportByWindowDS";
    private const string USP_REPORT = "uspRptOnTimeReportByWindow",TBL_REPORT = "NewTable";
        ...
        if(ds.Tables[TBL_REPORT].Rows.Count >= 0) {
            switch(e.CommandName) {
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=OnTimeByWindow.xls");
