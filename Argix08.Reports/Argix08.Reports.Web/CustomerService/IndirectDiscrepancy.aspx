<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="IndirectDiscrepancy.aspx.cs" Inherits="IndirectDiscrepancy" %>
...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0px" cellspacing="3px">
        ...
        <tr>
            <td align="right">&nbsp;</td>
            <td><asp:CheckBox ID="chkOverShort" runat="server" Text="Over/Short Only" width="120px" Checked="True" /></td>
            <td>&nbsp;</td>
        </tr>
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
        <tr>
