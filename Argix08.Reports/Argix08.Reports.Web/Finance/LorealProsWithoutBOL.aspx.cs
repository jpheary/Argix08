...
public partial class LorealProsWithoutBOL:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Loreal PROs Without BOL";
    private const string REPORT_SRC = "/Finance/Loreal PROs Without BOL";
    private const string REPORT_DS = "DataSet1";
    private const string USP_REPORT = "uspInvLorelProsWithoutBOLGetList",TBL_REPORT = "NewTable";
