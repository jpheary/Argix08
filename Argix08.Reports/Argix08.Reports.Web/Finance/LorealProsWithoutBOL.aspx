<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="LorealProsWithoutBOL.aspx.cs" Inherits="LorealProsWithoutBOL" %>
...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0" cellspacing="3px">
        <tr style="font-size:1px"><td width="72px">&nbsp;</td><td width="384px">&nbsp;</td><td>&nbsp;</td></tr>
         <tr>
            <td colspan="2"><uc1:DualDateTimePicker ID="ddpSetup" runat="server" Width="332px" LabelWidth="72px" DateDaysBack="366" DateDaysForward="0" DateDaysSpread="366" OnDateTimeChanged="OnFromToDateChanged" /></td>
            <td>&nbsp;</td>
        </tr>
