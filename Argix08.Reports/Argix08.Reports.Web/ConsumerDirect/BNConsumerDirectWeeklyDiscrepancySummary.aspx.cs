...
public partial class BNConsumerDirectWeeklyDiscrepancySummary:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "B&N Consumer Direct Weekly Discrepancy Summary";
    private const string REPORT_SRC = "/Consumer Direct/BN Consumer Direct Weekly Discrepancy Summary";
    private const string REPORT_DS = "DataSet1";
    private const string USP_REPORT = "uspRptBNWeeklyConsumerDirectDiscrepancySummary",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _end });
