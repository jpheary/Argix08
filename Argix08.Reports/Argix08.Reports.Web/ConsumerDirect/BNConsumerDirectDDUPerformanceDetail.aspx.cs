...
public partial class BNConsumerDirectDDUPerformanceDetail:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "B&N Consumer Direct DDU Performance Detail";
    private const string REPORT_SRC = "/Consumer Direct/BN Consumer Direct DDU Performance Detail";
    private const string REPORT_DS = "BN_DDU_DS";
    private const string USP_REPORT = "uspRptBNDDUPerformance2",TBL_REPORT = "NewTable";
