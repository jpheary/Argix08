...
public partial class ConsumerDirectDDUWeeklySummaryByAgent:System.Web.UI.Page {
    //Members
    private const string REPORT_NAME = "Consumer Direct DDU Weekly Summary By Agent";
    private const string REPORT_SRC = "/Consumer Direct/Consumer Direct DDU Weekly Summary By Agent";
    private const string REPORT_DS = "DataSet1";
    private const string USP_REPORT = "uspRptConsumerDirectDDUWeeklySummaryByAgent",TBL_REPORT = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        DataSet ds = enterprise.FillDataset(USP_REPORT,TBL_REPORT,new object[] { _start,_end,_vendor,_delivDays });
