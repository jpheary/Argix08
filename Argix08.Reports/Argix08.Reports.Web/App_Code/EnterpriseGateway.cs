...
namespace Argix {
    ...
    public class EnterpriseGateway {
        ...
        public TLDS GetTLs(string terminal, int daysBack) {
        ...
        public TLDS GetTLs(string terminal, DateTime startDate, DateTime endDate) {
            //Event handler for change in selected terminal
            TLDS tls = new TLDS();
            try {
                DataSet ds = FillDataset(USP_TLS,TBL_TLS,new object[] { terminal,startDate.ToString("yyyy-MM-dd"),endDate.ToString("yyyy-MM-dd") });
        ...
        public TLDS FindTL(string terminal, string TLNumber) {
            //
            TLDS tls = new TLDS();
            try {
        ...
        public InductedFreightDS GetInductedFreight(DateTime startImportedDate, DateTime endImportedDate, string terminalCode) {
            //
            InductedFreightDS freight = null;
            try {
                freight = new InductedFreightDS();
