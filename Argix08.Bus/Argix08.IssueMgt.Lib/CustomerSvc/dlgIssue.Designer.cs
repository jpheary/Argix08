namespace Argix.CustomerSvc {
    partial class dlgIssue {
        ...
        private void InitializeComponent() {
            ...
            this.ctlCompLoc = new Argix.Enterprise.CompanyLocation();
            ...
            this.ctlCompLoc.LocationChanged += new Argix.Enterprise.LocationEventHandler(this.OnLocationChanged);
            ...
            this.ctlContact.BeforeContactCreated += new Argix.Enterprise.ContactEventHandler(this.OnBeforeContactCreated);
            this.ctlContact.AfterContactCreated += new Argix.Enterprise.ContactEventHandler(this.OnAfterContactCreated);
            this.ctlContact.Error += new Argix.ControlErrorEventHandler(this.OnControlError);
            // 
            // cboIssueCategory
            // 
            this.cboIssueCategory.DisplayMember = "IssueTypeTable.Type";
        ...
        private Argix.Enterprise.CompanyLocation ctlCompLoc;
