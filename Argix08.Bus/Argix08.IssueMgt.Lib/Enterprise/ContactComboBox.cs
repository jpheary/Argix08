...
namespace Argix.Enterprise {
    ...
    public partial class ContactComboBox :UserControl {
        ...
        [Category("Data")]
        [Description("Gets or sets the datasource for this Argix.Enterprise.ContactComboBox.")]
        [RefreshProperties(RefreshProperties.Repaint)]
        [AttributeProvider(typeof(IListSource))]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.DataSource")]
        public ContactDS DataSource {
            get { return (ContactDS)this.cboContact.DataSource;  }
            set { 
                this.cboContact.DataSource = value;
                //if(this.cboContact.Items.Count > 0) this.cboContact.SelectedIndex = 0;
                //OnContactChanged(null,EventArgs.Empty);
            }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Category("Data")]
        [Description("Gets or sets the property to display for this Argix.Enterprise.ContactComboBox.")]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.DisplayMember")]
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Category("Data")]
        [Description("Gets or sets the property to use as the actual value for the items in the Argix.Enterprise.ContactComboBox.")]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.ValueMember")]
        ...
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Description("Gets an object representing the collection of the items contained in the Argix.Enterprise.ContactComboBox.")]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.Items")]
        ...
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.SelectedIndex")]
        [Localizable(false)]
        public int SelectedIndex { get { return this.cboContact.SelectedIndex; } 
            set { this.cboContact.SelectedIndex = value; //OnContactChanged(null,EventArgs.Empty); 
            } 
        }
        ...
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.SelectedValue")]
        [Localizable(false)]
        public object SelectedValue { get { return this.cboContact.SelectedValue; } 
            set { if(value != null) this.cboContact.SelectedValue = value; //OnContactChanged(null,EventArgs.Empty); 
            } 
        }
        ...
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.Text")]
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Localizable(false)]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.ReadOnly")]
        public bool ReadOnly {
            get { return this.mReadOnly; } 
            set {
                this.mReadOnly = value;
                if(this.mReadOnly) {
                    this.cboContact.DropDownStyle = ComboBoxStyle.Simple;
                    //this.cboContact.BackColor = System.Drawing.SystemColors.Window;
                    this.cboContact.Enabled = this.btnContact.Enabled = false;
                    this.btnContact.Visible = false;
                }
                else {
                    this.cboContact.DropDownStyle = ComboBoxStyle.DropDownList;
                    this.cboContact.Enabled = this.btnContact.Enabled = true;
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Localizable(false)]
        [HelpKeywordAttribute("Argix.Enterprise.ContactComboBox.FontBold")]
        ...
        private void OnContactChanged(object sender,EventArgs e) {
            ...
            try {
                ...
                if(this.cboContact.SelectedValue != null) {
                    ...
                    ContactDS.IssueContactTableRow[] cs = (ContactDS.IssueContactTableRow[])this.DataSource.IssueContactTable.Select("ID=" + this.cboContact.SelectedValue);
                    if(cs.Length > 0) {
                        this.mContact = new Contact(cs[0]);
