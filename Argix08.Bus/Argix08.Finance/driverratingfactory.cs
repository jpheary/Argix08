...
namespace Argix.Finance {
	...
	public class DriverRatingFactory {
		//Members
        private static DriverRatesDS _RateTypes = null;
        ...
        public static DriverRatesDS RateTypes { 
            get {
                try {
                    if(_RateTypes == null) {
        ...
        public static DriverRatesDS GetMileageRates(DateTime date) { return GetMileageRates(date,null,-1); }
        public static DriverRatesDS GetMileageRates(DateTime date,string terminalAgent) { return GetMileageRates(date,terminalAgent,-1); }
        public static DriverRatesDS GetMileageRates(DateTime date,string terminalAgent, int equipmentTypeID) {
        ...
        #endregion
        #region Unit Rates
        public static DriverRatesDS GetUnitRates(DateTime date) { return GetUnitRates(date,null,-1); }
        public static DriverRatesDS GetUnitRates(DateTime date,string terminalAgent) { return GetUnitRates(date,terminalAgent,-1); }
        ...
        public static DriverRatesDS GetMileageRouteRates(DateTime date) { return GetMileageRouteRates(date,null,null); }
        public static DriverRatesDS GetMileageRouteRates(DateTime date,string terminalAgent) { return GetMileageRouteRates(date,terminalAgent,null); }
        ...
        public static DriverRatesDS GetUnitRouteRates(DateTime date) { return GetUnitRouteRates(date,null,null); }
        public static DriverRatesDS GetUnitRouteRates(DateTime date,string terminalAgent) { return GetUnitRouteRates(date,terminalAgent,null); }
        public static DriverRatesDS GetUnitRouteRates(DateTime date,string terminalAgent,string route) {
