...
namespace Argix.Finance {
    ...
    public class DriverRates {
        ...
        public void Refresh() {
            ...
            try {
                this.mRates.Clear();
                this.mRates.Merge(new DriverRatingService("").GetMileageRates(this.mRatesDate,this.mAgentNumber));
                this.mRates.Merge(new DriverRatingService("").GetUnitRates(this.mRatesDate,this.mAgentNumber));
                this.mRates.Merge(new DriverRatingService("").GetMileageRouteRates(this.mRatesDate,this.mAgentNumber));
                this.mRates.Merge(new DriverRatingService("").GetUnitRouteRates(this.mRatesDate,this.mAgentNumber));
            }
